...
## Skills Organization
- `.kilo/skills/gitnexus/` — 6 skills from GitNexus source (guide, cli, exploring, impact-analysis, debugging, refactoring)
- `.kilo/skills/codegraphcontext/` — CGC skill
- `.kilo/skills/graph-combo/` — Unified combo workflow skill
