---
description: Uninstall agent for GitNexus + CodeGraphContext. Removes MCP config entries, AGENTS.md sections, skill files, indexes, and platform directives.
mode: subagent
permission:
  edit: allow
  bash: allow
...
| Skill files | `--remove skills` | Removes skill directories |
